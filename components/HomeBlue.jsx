...
const HomeBlue = () => {
  ...
  return (
    <div className="">
      <div className="pricingBg w-full lg:h-[859px] h-[700px] lg:rounded-b-[80px] rounded-b-[40px] lg:px-20 px-5 lg:pt-[300px] pt-[150px] z-10 ">
      ...
      <div className="flex lg:flex-row flex-col items-center justify-center lg:-mt-[140px] -mt-[90px]">
        <img
