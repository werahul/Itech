        ...
        <div className="px-20 py-[156px]">
          <div className="w-full  border border-[#004C3F] rounded-[20px] flex">
            <div className="w-[45%] bg-[#004C3F] h-full p-10 rounded-l-[20px]">
              ...
              <div className="space-y-[28px] mt-16">
              ...
              <form className="">
                <div className="space-y-6">
                  ...
                  <div className="">
                    ...
                    <select className="border font-inter text-[16px] px-5 placeholder-[#000049] border-[#000049] rounded-[8px] h-[64px] w-full">
                  ...
                  <div className="">
                    ...
                    <textarea
                      type="text"
                      className="border font-inter text-[16px] pt-5 px-5 placeholder-[#000049] border-[#000049] rounded-[8px] h-[140px] w-full"
                    />
                  </div>
                </div>
