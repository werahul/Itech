    ...
    <div className="bg-[#F5F3F6]">
      <div className="lg:px-20 px-5 lg:py-[156px] py-20 max-container">
        <div className="gradient-border">
          <div className="lg:h-full h-auto w-full bg-[#eeeeee] rounded-[20px] absolute top-0 left-0 lg:py-16 py-8 lg:px-8 px-5 flex lg:items-center">
            <div className=" lg:flex items-start justify-between space-x-10">
              <div className="lg:w-[54%]">
                <p className="font-normal lg:text-[48px] text-[32px] lg:leading-[56px] leading-[36px] text-[#000049] font-flyHead">
                  READY TO LEAD WITH <br /> ENGINEERING INTELLIGENCE <br />{" "}
                  INNOVATION?
                </p>
                <p className="font-inter font-normal lg:text-[18px] text-[16px] lg:leading-[27px] leading-[24px] mt-5 text-[#000049]">
